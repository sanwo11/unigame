...
<?php
	...
	class StudentVerify extends DatabaseObject{
		
	protected static $table_name = "studentverify";		
	...
	public function setstudentverify(){
		if(!empty($this->errors)){ 
				return false; 			
		}
		if(empty($this->email)){ 
			$this->errors[] = " Please enter your school email address.";
			return false;
		}
